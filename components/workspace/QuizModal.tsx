    ...
    >
      {phase === "loading" && (
        <div className="flex flex-col items-center justify-center py-16 gap-3">
          <Spinner size="lg" />
          <p className="text-sm text-[var(--text-2)]">Generating quiz questions…</p>
        </div>
      )}
      ...
      {phase === "question" && q && (
        <div className="p-6 space-y-5">
          ...
          {/* Question */}
          <p className="text-[15px] font-medium text-[var(--text-1)] leading-snug">
            {q.question}
          </p>
          ...
          {submitted && (
            <div className={cn(
              "rounded-xl px-4 py-3 text-sm leading-relaxed animate-fade-in",
        ...
        <div className="p-8 text-center space-y-6 animate-fade-in">
          <div className="space-y-2">
            ...
            <p className="text-[var(--text-2)] text-sm">
              You got <span className="font-semibold text-brand-600">{score}</span> out of{" "}
